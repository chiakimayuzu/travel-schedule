...
from .views import (
    ...
    PortfolioView, modal_search_touristspot, modal_wanted_spot, my_review_detail, my_review_list,regist_touristspot,check_dupe_tourist_spot,
...
urlpatterns = [
    ...
    # 行きたいリストモーダル用URL
    path('modal_wanted_spot/', modal_wanted_spot, name='modal_wanted_spot'),
    ]
